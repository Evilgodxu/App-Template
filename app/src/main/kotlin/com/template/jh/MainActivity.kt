...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val privacyAccepted by userPreferencesRepository.privacyAccepted.collectAsStateWithLifecycle(initialValue = null)
            ...
            var startDestinationKey by rememberSaveable { mutableStateOf<String?>(null) }
            if (startDestinationKey == null && privacyAccepted != null) {
                startDestinationKey = if (privacyAccepted == true) "home" else "privacy"
            }

            val startDestination = when (startDestinationKey) {
                "home" -> Home
                "privacy" -> Privacy
                else -> null
            }
